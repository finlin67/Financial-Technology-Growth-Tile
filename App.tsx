...
export default function App() {
  return (
    <div className="bg-[#0f172a] min-h-screen text-slate-100 font-sans overflow-hidden flex flex-col relative">
      ...
      {/* Header */}
      <header className="flex items-center justify-between px-6 md:px-8 py-3 bg-[#0f172a]/80 backdrop-blur-md border-b border-slate-800/50 z-50 shrink-0 sticky top-0">
      ...
      <main className="flex-1 relative flex flex-col z-10">
        ...
        {/* Stats Footer */}
        <div className="mt-auto px-8 py-6 border-t border-slate-800/50 bg-[#0f172a]/30 backdrop-blur-sm">
